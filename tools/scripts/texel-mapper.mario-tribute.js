...
module.exports = function(gameWindow, texelGuide, map = {}) {
  ...
  var FileHandler = ServerSideFile || console.error('requires __ServerSideFile');
  ...
  var $MOD = this;
  new Gamelab.Module().load('./scripts/texel-mapper-level-packs/mario-builder.pack.js', function(construct){
