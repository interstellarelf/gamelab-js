...
module.exports = function(sourceTexels){
    ...
    this.sourceTexels.do(function() {
      ...
      this.push(new Gamelab.Sprite('./images/town-style-01/texel2d-04.png'));

      this.last().name = '04';
      this.last().describe = 'A basic texel bearing the number 4. Use it for any level-tile';
    ...
    this.sourceTexels.do(function() {
      ...
      this.push(new Gamelab.Sprite('./images/town-style-01/texel2d-05.png'));

      this.last().name = '05';
      this.last().describe = 'A basic texel bearing the number 5. Use it for any level-tile';
    ...
    this.sourceTexels.do(function() {
      ...
      this.last().group = 'background-tiles';
