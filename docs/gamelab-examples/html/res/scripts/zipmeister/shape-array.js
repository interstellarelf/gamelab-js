module.exports = function(rows, cols, containerSprite) {
  ...
  var sources = [
    './res/images/shapes/triangle-sheet.png',
    './res/images/shapes/cross-sheet.png',
    './res/images/shapes/square-sheet.png',
  ];
  ...
  function addSprite(x, y){
    ...
    sprite.onLoad(function() {
      ...
      if (ix == 0) {
        this.Anime(this.colorAnimations.orange);
        this.colorKey = 'orange';
      }

      if (ix == 1) {
        this.Anime(this.colorAnimations.skyblue);
        this.colorKey = 'skyblue';
      }
      if (ix == 2) {
        this.Anime(this.colorAnimations.blue);
        this.colorKey = 'blue';
      }
      if (ix == 3) {
      ...
      if (ix == 5) {
        this.Anime(this.colorAnimations.purple);
  ...
  return { sprites:spriteList, getAllSpritesByKeyVal:getAllSpritesByKeyVal,  rows:rows, cols:cols, addSprite:addSprite };
